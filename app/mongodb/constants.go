...
var (
	...
	JwtAccessTokenCollection = commonmongodb.NewCollection("JwtAccessToken", nil, nil)

	// JwtAccessTokenLogCollection is the JWT access token log collection in MongoDB
	JwtAccessTokenLogCollection = commonmongodb.NewCollection("JwtAccessTokenLog", nil, nil)

	// JwtRefreshTokenCollection is the JWT refresh token collection in MongoDB
	JwtRefreshTokenCollection = commonmongodb.NewCollection("JwtRefreshToken", nil, nil)

	// JwtRefreshTokenLogCollection is the JWT refresh token log collection in MongoDB
	JwtRefreshTokenLogCollection = commonmongodb.NewCollection("JwtRefreshTokenLog", nil, nil)
	...
	RolePermissionCollection = commonmongodb.NewCollection("RolePermission", nil, nil)

	// UserLogInAttemptCollection is the user log in attempt collection in MongoDB
	UserLogInAttemptCollection = commonmongodb.NewCollection("UserLogInAttempt", nil, nil)
